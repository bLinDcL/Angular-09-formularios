...
export class DataComponent {
  ...
  usuario: any = {
    nombreCompleto: {
      nombre: 'Felipe',
      apellido: 'Vergara Albornoz',
    },
    correo: 'fe.vergaraa@gmail.com',
  ...
  constructor() {
    ...
    this.forma = new FormGroup({
      'nombreCompleto': new FormGroup({
        ...
        'apellido': new FormControl( '' , [ Validators.required, this.noVergara ] ),
      }),
  ...
  noVergara( control: FormControl ): {[s:string]:boolean} {
    if ( control.value === 'Vergara' ) {
      return {
        noVergara: true
      }
    }
